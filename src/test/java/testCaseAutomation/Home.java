        ...
        try {
            ...
            for (WebElement item : cartContents) {
                if (item.findElement(By.className("css-1gjj37g")).getText().contains(productName)) {
                    ...
                    WebElement plusIcon = item.findElement(By.xpath("//div[contains(text(),'"+productName+"')]/following-sibling::div//button[2]"));
                    WebElement minusIcon = item.findElement(By.xpath("//div[contains(text(),'"+productName+"')]/following-sibling::div//button[1]"));
