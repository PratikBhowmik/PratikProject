...
public class Checkout {
    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            if (addNewAddressButton.isDisplayed()) {
                ...
                WebElement addressField = driver.findElement(By.xpath("//textarea[@placeholder = 'Enter your complete address']"));
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            WebElement radioButtonForAddress = driver.findElement(By.xpath("//input[@type='radio']"));
